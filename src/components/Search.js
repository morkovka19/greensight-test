...
export default function Search({onSearch}){
    ...
    const [form, setForm] = useState('Not selected');
    ...
    const handleClearFilter = (e) =>{
        e.preventDefault();
        setForm('Not selected');
        setPosition('Not selected');
        onSearch({form: 'Not selected', position: 'Not selected'})
    };
        ...
        <form className="search" typeof="submit">
            <div className="search__fieldset">
                <div className="search__input-block">
                    ...
                    <div onClick={handleClickForm} className={`search__select ${form === 'Not selected' ? 'search__select_no-selected' : null}`}>{form}<img src={ArrowIcon} alt="стрелочка" className={`search__icon ${formOpen ? 'search__icon_rotate' : null}`}/></div>
                ...
                <div className="search__input-block">
                    ...
                    <div onClick={handleClickPosition} className={`search__select ${position === 'Not selected' ? 'search__select_no-selected' : null}`}>{position}<img src={ArrowIcon} alt="стрелочка" className={`search__icon ${positionOpen ? 'search__icon_rotate' : null}`}/></div>
            ...
            <button onClick={handleClearFilter} className={`search__button-clear ${form !== 'Not selected' || position !== 'Not selected' ? 'search__button-clear_visible' : null}`}><img src={CloseImage} alt='крестик' className="search__icon"/> Clear filters</button>
        </form>
    )
}